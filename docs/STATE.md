...
## Status
- **Phase B 2026-07-11:** opened draft PR #136 for #93. Every `WorldScene` Net, EventBus, scale, and development-hook listener now has deterministic shutdown/destroy ownership through a pure `ListenerScope`; the targeted remount/teardown test and touched-file ESLint passed. Independent review and CI are pending.
