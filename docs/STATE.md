...
- **The complete live tracker graph is parent #90 with native sub-issues #91–#132 and 130 native blocking edges.** PR #134/#91 and PR #135/#92 are merged; #91 is production-verified and #92 is awaiting its main deployment verification. Draft PR #136 implements #93 with a real scene remount regression and still requires independent re-review plus green current-head CI. #96 is also ready.
...
- **Phase B 2026-07-11:** PR #134 / #91 merged as `1f7c368`; production verification passed. PR #135 / #92 merged as `4d4a31f` after independent READY and green CI; production verification is pending.
