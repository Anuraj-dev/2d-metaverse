...
- **The complete live tracker graph is parent #90 with native sub-issues #91–#132 and 130 native blocking edges.** PR #134/#91 and PR #135/#92 are merged and production-verified. Draft PR #136 implements #93 with a real scene remount regression and still requires independent re-review plus green current-head CI. #96 and #99 are also ready.
