# 2D Metaverse — State
> Gather/Zep-style 2D metaverse (app name: **hyprverse**): walk a styled office campus, proximity voice/video, admin-gated meeting rooms, arcade + board-game tables. · Last checkpoint: 2026-07-11 (LiveKit parity PR #134)
...
- **The complete live tracker graph is parent #90 with native sub-issues #91–#132 and 130 native blocking edges.** Every child has acceptance criteria plus independent review, CI, and deployment-verification gates. Draft PR #134 implements #91 (local/CI LiveKit v1.9.12 parity plus a real signaling-path probe); independent review and CI are pending. The remaining ready frontier is #92 (truthful auth failures) and #93 (WorldScene lifecycle). Promote later issues only when their native blockers are closed and the milestone order permits them.
