...
- **The complete live tracker graph is parent #90 with native sub-issues #91–#132 and 130 native blocking edges.** PR #134 shipped #91 with green CI, production deployment, matching health SHA, and a passing production signaling probe; PR #135 shipped #92. #96 now defaults microphone/camera off, persists explicit choices only for the browser page-session, and keeps fresh world/room/stage connections receive-only in `fix/consent-safe-media-defaults`; independent review, CI, merge, and production verification remain.
