...
| benchmark-grok-4.5.md | grok-4.5 capability benchmark from the campus art restyle (19-agent fan-out, 2026-08-01) |
...
> rule, compiler standard, per-subsystem how-tos). `AGENTS.md` is the router for Codex/opencode.
