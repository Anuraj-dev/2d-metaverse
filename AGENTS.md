...
> Note: `CLAUDE.md` in the repo root additionally carries this project's detailed operating rules
> (monorepo layout, the shared-contract rule, compiler standard, subsystem how-tos). Codex/opencode
> readers should read `CLAUDE.md` too — it is the authoritative rulebook, not just a router.
